<template>
  <div class="">
    <section class="relative text-white">
      <div
        class="bg-gradient-to-r from-green-500 to-blue-400 py-10 sm:py-16 md:pt-24 md:pb-60 border-b-2 border-gray-700"
      >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 md:flex lg:px-8">
          ...
          >
            <h2
              class="text-3xl font-black leading-tight sm:text-5xl lg:text-7xl flex font-extrabold"
            >
              Draw
              <span class="whitespace-nowrap pl-4"
                >And <span class="">Get Rated </span></span
              >
            </h2>
            <img src="../assets/img/star.png" class="h-16 pt-4" />
            <p class="mt-4 font-medium md:text-5xl">
              Draw what you want, publish it, and other people will rate your
              drawing !
            </p>
            ...
            >
              <button
                class="relative mt-4 rounded-lg bg-yellow-500 px-8 py-4 font-medium text-white text-2xl shadow transition hover:bg-yellow-600"
              >
                <div
                  class="-scale-x-100 absolute left-0 -ml-6 -bottom-10 hidden h-16 w-20 pt-6 -rotate-12 md:inline-flex"
                >
                  <svg
                    viewBox="0 0 82 35"
                    fill="none"
      ...
      <div
        class="group relative mx-auto -mt-40 mb-40 hidden w-full max-w-3xl overflow-hidden rounded-xl border-8 border-yellow-200 bg-green-100 shadow-lg md:block"
      >
        <img
          class="group-hover:opacity-70 h-full w-full opacity-50 duration-500"
          src="../assets/img/gif_cat.gif"
          alt=""
        />
      </div>
      <div class="mx-auto grid grid-cols-3 w-full pb-32">
        <div
          class="flex flex-col items-center justify-center text-center px-4 lg:px-0"
        >
          <img src="../assets/img/account2.svg" class="w-44" />
          <p
            class="text-4xl font-bold text-gray-700 capitalize tracking-wide mt-8"
          >
            Create your account
          </p>
        </div>
        <div
          class="flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0 -mt-40"
        >
          <img src="../assets/img/stars.svg" class="w-44" />
          <p
            class="text-4xl font-bold text-gray-700 capitalize tracking-wide mt-8"
          >
            Get rated by other drawers
          </p>
        </div>
        <div
          class="flex flex-col items-center justify-center text-center px-4 lg:px-0"
        >
          <img src="../assets/img/draw.svg" class="w-44" />
          <p
            class="text-4xl font-bold text-gray-700 capitalize tracking-wide mt-8"
          >
            Draw freely
          </p>
          <p class="text-xl text-gray-700 uppercase mt-4"></p>
        </div>
      </div>
      <div
        class="bg-gradient-to-r from-green-500 to-blue-400 border-y-4 border-gray-700 py-20 md:bg-gradient-to-r"
      >
        <div
          class="container m-auto px-6 text-center md:px-12 lg:px-20 space-y-12"
        >
          <h2 class="text-4xl font-bold text-white md:text-5xl">
            Polish your creative and drawing skill
          </h2>
        </div>
      </div>
    </section>
